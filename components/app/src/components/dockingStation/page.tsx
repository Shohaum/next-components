// component imports
import DockerLink from "@/components/dockingStation/dockerLink";
        ...
        <main style={{ width: "100%", height: "100dvh", display: "flex", justifyContent: "center", alignItems: "center" }}>
            ...
            <div style={{ width: "fit-content", height: "fit-content" }}>
                <DockerLink>
                    ...
                    <DockList>
                        <Magnet style={{ background: "var(--gray-300)" }} />
                        <DockItem slug="cloudflare">

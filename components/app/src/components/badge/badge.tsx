...
const Badge = React.forwardRef<HTMLElement, BadgeProps>(({ children, variant = "default", ...props }, ref) => {
    const variantStyles: Record<string, React.CSSProperties> = {
        verified: { backgroundColor: "var(--green-600)", color: "var(--white-100)" },
        primary: { backgroundColor: "var(--gray-1000)", color: "var(--themed-matched-color)" },
        secondary: { backgroundColor: "var(--gray-200)" },
        success: { backgroundColor: "var(--green-600)", color: "var(--white-100)" },
        danger: { backgroundColor: "var(--red-800)", color: "var(--white-100)" },
        warning: { backgroundColor: "var(--amber-800)", color: "var(--white-100)" },
        default: {},
    };

    const combinedStyle = { ...variantStyles[variant], ...props.style };
